...
--Code: C Source code, solution file Code\DepthRefineOnMST.sln
--Dataset: Middlebury data sets 
--Demo: Demo program

2.Run Demo Program
You can run Demo\Test.bat, input and output files are in directory Dataset.

3.Build Project
We built this project with VS2008, Windows7 64bit. You can build your project by using the source code.
