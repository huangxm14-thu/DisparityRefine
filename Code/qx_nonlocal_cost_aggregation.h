...
public:
	...
	int refineFast(unsigned char**disparity,unsigned char**disparityL,unsigned char**disparityR);
	int FillHoleLR_Simple(unsigned char**disparityL, unsigned char *texture);
private:
...
private:
	...
	double****m_buf_d4,***m_disparity_vol,***m_disparity_vol_temp;
};
#endif