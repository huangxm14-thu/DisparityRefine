...
public:
	...
	int build_treeDisparity(unsigned char*texture, unsigned char*disparity);
	...
	int filterDisparity(double*cost,double*cost_backup,unsigned char *src,unsigned char *dst);
